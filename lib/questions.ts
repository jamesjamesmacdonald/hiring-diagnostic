...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    stage: 'align',
    order: 2,
    text: "Have you written a one-sentence success criteria in the form: 'I will know this hire worked when X by Y because Z'?",
    source: 'James MacDonald (ALIGN Framework, The Hiring Funnel Fix)',
  ...
  // ============ ATTRACT ============
  {
    ...
    stage: 'attract',
    order: 1,
    text: 'Is your job description built around a specific behavioural signal, what success will look like, not credentials or years of experience?',
    source: "Michael Batko's hiring principles and BTT Episode 1",
  ...
  },
  {
    ...
    stage: 'attract',
    order: 2,
    text: 'Does your job ad and outreach sell the role to strong candidates, not just list tasks and requirements?',
    source: 'James MacDonald, The Hiring Funnel Fix',
    whyItMatters: 'Strong candidates have options. A job ad that lists tasks reads like every other ad. Sell the role or lose them.',
  },
  {
    id: 'attract-3',
    stage: 'attract',
  ...
  // ============ ASSESS ============
  {
    ...
    source: 'James MacDonald (Interview Scorecard, The Hiring Funnel Fix)',
  ...
  },
  {
    ...
    stage: 'assess',
    order: 3,
    text: 'Do your reference calls dig into how the candidate grew over time, not just confirm what they did?',
    source: "Michael Batko's hiring principles",
    whyItMatters: 'Generic reference questions get generic answers. Specific ones reveal real signal.',
  },
  {
    id: 'assess-4',
    stage: 'assess',
  ...
  // ============ CLOSE ============
  {
    ...
    source: 'James MacDonald (pre-close prompt, The Hiring Funnel Fix)',
  ...
  },
  {
    ...
    stage: 'close',
    order: 2,
    text: "Do you understand what is driving the candidate's decision before you build the offer?",
    source: 'James MacDonald (pre-close prompt)',
    whyItMatters: 'An offer built without knowing what the candidate values is a guess. Ask first. Then build.',
  },
  {
    id: 'close-3',
    stage: 'close',
  ...
  },
  {
    ...
    stage: 'close',
    order: 4,
    text: "Is your offer's benefits package built for what candidates value now, not a 2019 list of perks?",
    source: 'BTT Episode 1',
    whyItMatters: 'What looked like a perk five years ago is table stakes. The package has to match what candidates weigh today.',
  },
  ...
  },
  {
    ...
    source: "Michael Batko's hiring principles + James MacDonald (30-day Playbook, The Hiring Funnel Fix)",
